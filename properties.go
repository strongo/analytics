...
// Properties are used to represent properties in messages that support it.
// It is a free-form object, so the application can set any value it sees fit,
// but a few helper methods are defined to make it easier to instantiate properties
// with common fields.
